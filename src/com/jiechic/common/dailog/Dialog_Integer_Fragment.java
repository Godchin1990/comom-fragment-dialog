...
public class Dialog_Integer_Fragment extends DialogFragment{
    ...
    public static Dialog_Integer_Fragment newInstance() {
        return new Dialog_Integer_Fragment();
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
    	...
    	View v=inflater.inflate(R.layout.fragment_dialog_integer, (ViewGroup)((Activity) context).findViewById(R.id.dialog_integer));
    	final EditText editText=(EditText) v.findViewById(R.id.dialog_integer_edittext);
	...
	private void close(boolean isupdate) {
		...
		Dialog_Integer_Fragment.this.dismiss();
